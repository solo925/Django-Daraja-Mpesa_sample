"""
Django settings for MpesaPayment project.
...
SECRET_KEY = 'django-insecure-wcns-8j6_x@sw48lyy&rdf(m-gqh**%&akm603sp*s-uyk@wry'
...
ROOT_URLCONF = 'MpesaPayment.urls'
...
WSGI_APPLICATION = 'MpesaPayment.wsgi.application'
